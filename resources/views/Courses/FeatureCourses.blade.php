        ...
        <div class="container">
            <div class="row align-items-end mb-7">
                <div class="col-xl mb-5 mb-xl-0">
                    <h2 class="mb-1">FEATURED COURSES</h2>
                    <p class="font-size-lg text-capitalize mb-0">Explore Our Premier Course Selection.</p>
                </div>
                <div class="col-xl-auto">
                    <a href="./course-list-v1.html" class="d-flex align-items-center fw-medium">
                        Browse All
                    ...
                    <div class="card border shadow sk-fade">
                        ...
                        <div class="card-zoom position-relative rounded-bottom-0">
                            <div class="badge-float sk-fade-top top-0 right-0 mt-4 me-4">
                                <a href="./course-single-v3.html" class="btn btn-xs btn-dark text-white rounded-circle lift opacity-dot-7 me-1 p-2 d-inline-flex justify-content-center align-items-center w-36 h-36">
                                    <!-- Icon -->
                                ...
                                <a href="./course-single-v3.html" class="btn btn-xs btn-dark text-white rounded-circle lift opacity-dot-7 p-2 d-inline-flex justify-content-center align-items-center w-36 h-36">
                                    <!-- Icon -->
                            ...
                            <a href="./course-single-v3.html" class="card-img sk-thumbnail img-ratio-10 d-block rounded-bottom-0">
                                <img class="shadow-light-lg" src="assets/img/products/product-15.jpg" alt="...">
                            </a>

                            <span class="badge sk-fade-top badge-lg badge-orange badge-pill badge-float top-0 left-0 mt-4 ms-4">
                                <span class="text-white text-uppercase fw-bold font-size-xs">BEST SELLER</span>
                            </span>

                            <div class="card-float sk-fade-bottom bottom-0 left-0 mb-3 ms-4">
                                <ins class="h5 mb-0 text-white">Rs.21.99</ins>
                            </div>
                        </div>
                        ...
                        <div class="card-footer p-4 position-relative">
                            ...
                            <div class="avatar avatar-lg badge-float position-absolute top-0 right-0 mt-n5 me-5 rounded-circle shadow border border-white border-w-lg">
                                <img src="assets/img/avatars/avatar-1.jpg" alt="..." class="avatar-img rounded-circle">
                            </div>

                            <!-- Preheading -->
                            <a href="./course-single-v3.html"><span class="mb-1 d-inline-block text-gray-800">Photography</span></a>


                            <!-- Heading -->
                            <a href="./course-single-v3.html" class="d-block"><h5 class="line-clamp-2 h-48 h-lg-58 mb-1">Fashion Photography From Professional</h5></a>
                ...
                <div class="col-12 col-md-6 col-xl-3 pb-4 pb-md-7" style="padding-right:15px;padding-left:15px;">
                    ...
                    <div class="card border shadow sk-fade">
                        ...
                        <div class="card-zoom position-relative rounded-bottom-0">
                            ...
                            <a href="./course-single-v3.html" class="card-img sk-thumbnail img-ratio-10 d-block rounded-bottom-0">
                                <img class="shadow-light-lg" src="assets/img/products/product-16.jpg" alt="...">
                            </a>
                        ...
                        <div class="card-footer p-4 position-relative">
                            ...
                            <!-- Heading -->
                            <a href="./course-single-v3.html" class="d-block"><h5 class="line-clamp-2 h-48 h-lg-58 mb-1">Learn Figma: User Interface Essentials - UI/UX Design</h5></a>
                ...
                <div class="col-12 col-md-6 col-xl-3 pb-4 pb-md-7" style="padding-right:15px;padding-left:15px;">
                    ...
                    <div class="card border shadow sk-fade">
                        ...
                        <div class="card-zoom position-relative rounded-bottom-0">
                            ...
                            <a href="./course-single-v3.html" class="card-img sk-thumbnail img-ratio-10 d-block rounded-bottom-0">
                                <img class="shadow-light-lg" src="assets/img/products/product-23.jpg" alt="...">
                            </a>
                        ...
                        <div class="card-footer p-4 position-relative">
                            ...
                            <!-- Heading -->
                            <a href="./course-single-v3.html" class="d-block"><h5 class="line-clamp-2 h-48 h-lg-58 mb-1">The Complete Cyber Security Course : Hackers Exposed!</h5></a>
                ...
                <div class="col-12 col-md-6 col-xl-3 pb-4 pb-md-7" style="padding-right:15px;padding-left:15px;">
                    ...
                    <div class="card border shadow sk-fade">
                        ...
                        <div class="card-zoom position-relative rounded-bottom-0">
                            ...
                            <a href="./course-single-v3.html" class="card-img sk-thumbnail img-ratio-10 d-block rounded-bottom-0">
                                <img class="shadow-light-lg" src="assets/img/products/product-24.jpg" alt="...">
                            </a>
                            ...
                            <div class="card-float sk-fade-bottom bottom-0 left-0 mb-3 ms-4">
                                <ins class="h5 mb-0 text-white">Rs.199</ins>
                            </div>
                        </div>
                        ...
                        <div class="card-footer p-4 position-relative">
                            ...
                            <!-- Heading -->
                            <a href="./course-single-v3.html" class="d-block"><h5 class="line-clamp-2 h-48 h-lg-58 mb-1">Guide to Front-End Web Development and Design</h5></a>
                ...
                <div class="col-12 col-md-6 col-xl-3 pb-4 pb-md-7" style="padding-right:15px;padding-left:15px;">
                    ...
                    <div class="card border shadow sk-fade">
                        ...
                        <div class="card-zoom position-relative rounded-bottom-0">
                            ...
                            <div class="card-float sk-fade-bottom bottom-0 left-0 mb-3 ms-4">
                                <ins class="h5 mb-0 text-white">Rs.2999</ins>
                            </div>
                        </div>

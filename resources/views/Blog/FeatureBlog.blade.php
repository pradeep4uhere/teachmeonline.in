        ...
        <div class="row row-cols-md-2 row-cols-lg-3">
            <div class="col-md mb-5 mb-lg-0">
                ...
                <div class="card border shadow lift sk-fade">
                    ...
                    <div class="card-zoom position-relative rounded-bottom-0">
                        <a href="./blog-single.html" class="card-img d-block sk-thumbnail img-ratio-3 rounded-bottom-0"><img class="shadow-light-lg img-fluid" src="assets/img/post/post-1.jpg" alt="..."></a>
                    ...
                    <div class="card-footer p-4">
                        ...
                        <!-- Heading -->
                        <a href="./blog-single.html" class="d-block"><h5 class="line-clamp-2 h-48 h-lg-52 mb-1">The Best Destinations to Begin Your Round the World Trip</h5></a>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md mb-5 mb-lg-0">
                ...
                <div class="card border shadow lift sk-fade">
                    <!-- Image -->
                    <div class="card-zoom position-relative rounded-bottom-0">
                        <a href="./blog-single.html" class="card-img d-block sk-thumbnail img-ratio-3 rounded-bottom-0"><img class="shadow-light-lg img-fluid" src="assets/img/post/post-2.jpg" alt="..."></a>
                    ...
                    <div class="card-footer p-4">
                        ...
                        <!-- Heading -->
                        <a href="./blog-single.html" class="d-block"><h5 class="line-clamp-2 h-48 h-lg-52 mb-1">An Indigenous Anatolian Syllabic Script From 3500 Years Ago</h5></a>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md mb-5 mb-lg-0">
                ...
                <div class="card border shadow lift sk-fade">
                    <!-- Image -->
                    <div class="card-zoom position-relative rounded-bottom-0">
                        <a href="./blog-single.html" class="card-img d-block sk-thumbnail img-ratio-3 rounded-bottom-0"><img class="shadow-light-lg img-fluid" src="assets/img/post/post-3.jpg" alt="..."></a>
                    ...
                    <div class="card-footer p-4">
                        ...
                        <!-- Heading -->
                        <a href="./blog-single.html" class="d-block"><h5 class="line-clamp-2 h-48 h-lg-52 mb-1">10 Best Countries to Visit for Beginner Travelers</h5></a>
                    </div>
                </div>
            </div>
        </div>

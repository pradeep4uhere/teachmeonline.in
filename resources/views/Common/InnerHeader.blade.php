    ...
    <header class="navbar navbar-expand-xl navbar-light bg-white border-bottom py-2 py-xl-4">
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse z-index-lg" id="navbarCollapse">
                ...
                <!-- Toggler -->
                <button class="navbar-toggler outline-0 text-danger" type="button" data-bs-toggle="collapse" data-bs-target="#navbarCollapse" aria-controls="navbarCollapse" aria-expanded="false" aria-label="Toggle navigation">
                    <!-- Icon -->

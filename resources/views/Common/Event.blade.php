<section class="bg-white py-5 py-md-8">
    <div class="container">
        ...
        <!-- Card -->
        <div class="card border shadow p-2 lift mb-5">
            <div class="row gx-0 align-items-center">
                <!-- Image -->
                <a href="./event-single.html" class="col-auto d-block mw-md-130p" style="max-width: 120px;">
                ...
                <div class="col">
                    <div class="card-body py-0 px-md-5 px-3">
                        <a href="./event-single.html" class="d-block mb-2"><h5 class="mb-1 line-clamp-2">Elegant Light Box Paper Cut Dioramas New Design Conference</h5></a>
                ...
                <a href="./event-single.html" class="col-auto rounded-lg d-none d-md-flex w-130p align-self-stretch place-center bg-shark">
        ...
        <div class="card border shadow p-2 lift mb-5">
            <div class="row gx-0 align-items-center">
                <!-- Image -->
                <a href="./event-single.html" class="col-auto d-block mw-md-130p" style="max-width: 120px;">
                    <img class="img-fluid rounded shadow-light-lg h-100 h-md-auto o-f-c" src="assets/img/events/event-2.jpg" alt="...">
                </a>

                <!-- Body -->
                <div class="col">
                    <div class="card-body py-0 px-md-5 px-3">
                        <a href="./event-single.html" class="d-block mb-2"><h5 class="mb-1 line-clamp-2">Lambeth Safeguarding: Understanding Contextual Harm</h5></a>
        ...
        <div class="card border shadow p-2 lift mb-5">
            <div class="row gx-0 align-items-center">
                <!-- Image -->
                <a href="./event-single.html" class="col-auto d-block mw-md-130p" style="max-width: 120px;">
                    <img class="img-fluid rounded shadow-light-lg h-100 h-md-auto o-f-c" src="assets/img/events/event-3.jpg" alt="...">
                </a>

                <!-- Body -->
                <div class="col">
                    <div class="card-body py-0 px-md-5 px-3">
                        <a href="./event-single.html" class="d-block mb-2"><h5 class="mb-1 line-clamp-2">Discover Law - Get into the best UK law schools</h5></a>
        ...
        <div class="card border shadow p-2 lift mb-5">
            <div class="row gx-0 align-items-center">
                <!-- Image -->
                <a href="./event-single.html" class="col-auto d-block mw-md-130p" style="max-width: 120px;">
                    <img class="img-fluid rounded shadow-light-lg h-100 h-md-auto o-f-c" src="assets/img/events/event-4.jpg" alt="...">
                </a>

                <!-- Body -->
                <div class="col">
                    <div class="card-body py-0 px-md-5 px-3">
                        <a href="./event-single.html" class="d-block mb-2"><h5 class="mb-1 line-clamp-2">Undergraduate Open Day – Holloway Campus - 3 July 2020</h5></a>

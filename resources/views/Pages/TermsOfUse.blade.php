 ...
 <!-- MODALS
    ...
    <header class="py-8 py-md-12 overlay overlay-primary overlay-80" style="background-image: url(assets/img/covers/cover-19.jpg);">
        <div class="container text-center py-xl-5">
            <h1 class="display-4 fw-semi-bold mb-0 text-white">Terms & Conditions</h1>
        ...
        <div class="row">
            <div class="col-md-12 col-xl-12">
                <div class="tab-content" id="v-pills-tabContent">
                    ...
                    Terms of Use
                    <p class="mb-6">
These Terms of Use govern your use of the TeachMeOnline website and any associated services provided by TeachMeOnline. By accessing or using our website, you agree to comply with and be bound by these Terms of Use. If you do not agree with any part of these terms, please refrain from using our services.
                    </p>
                    <p class="mb-6">
Use of Services
a. Eligibility: You must be at least 18 years old to use our services. By accessing or using our website, you represent and warrant that you are 18 years of age or older.
                    </p>
                    <p class="mb-6">
b. User Account: In order to access certain features or services, you may be required to create a user account. You are responsible for maintaining the confidentiality of your account information and for all activities that occur under your account.
                    </p>
                    <p class="mb-6">
c. Prohibited Activities: You agree not to engage in any activity that may:
                    </p>
                    <p class="mb-6">
                        <p>
i. Violate any applicable laws, regulations, or third-party rights.
                        ...
                        <p>
ii. Impersonate any person or entity or falsely state or misrepresent your affiliation with any person or entity.
                        </p>
                        <p>
iii. Interfere with or disrupt the integrity or performance of our website or services.
                        </p>
                        <p>
iv. Use our website or services for any unauthorized commercial purposes.
                        </p>
                        <p>
v. Engage in any form of data mining, scraping, or similar data gathering or extraction methods.
                    </p>
                    <p class="mb-6">
Intellectual Property Rights
a. TeachMeOnline Content: The content on our website, including text, graphics, logos, images, audio clips, and software, is the property of TeachMeOnline and is protected by intellectual property laws. You may not modify, reproduce, distribute, or create derivative works based on such content without our prior written consent.
                    </p>
                    <p class="mb-6">
b. User-generated Content: By submitting or posting any content on our website, you grant TeachMeOnline a worldwide, non-exclusive, royalty-free license to use, reproduce, modify, adapt, publish, translate, distribute, and display such content in connection with our services.
                    </p>
                    <p class="mb-6">
Third-Party Links
Our website may contain links to third-party websites or services. These links are provided for your convenience only. TeachMeOnline does not endorse or have control over the content, policies, or practices of these third-party websites. You acknowledge and agree that TeachMeOnline shall not be responsible or liable for any damages or losses incurred as a result of your use of these third-party links.
                    </p>
                    <p class="mb-6">
Disclaimer of Warranties
TeachMeOnline provides its services on an "as-is" and "as available" basis. We make no representations or warranties of any kind, express or implied, regarding the reliability, accuracy, availability, or suitability of our services. Your use of our website and services is at your own risk.
                    </p>
                    <p class="mb-6">
Limitation of Liability
To the maximum extent permitted by law, TeachMeOnline and its affiliates, officers, directors, employees, or agents shall not be liable for any indirect, incidental, special, consequential, or punitive damages arising out of or related to your use of our website or services.
                    </p>
                    <p class="mb-6">
Changes to Terms of Use
TeachMeOnline reserves the right to modify or update these Terms of Use at any time without prior notice. We encourage you to review these terms periodically for any changes. Your continued use of our services after the posting of any modified terms constitutes your acceptance of such changes.
                    </p>
                    <p class="mb-6">
Governing Law and Jurisdiction
These Terms of Use shall be governed by and construed in accordance with the laws of the jurisdiction in which TeachMeOnline operates. Any dispute arising out of or relating to these terms shall be subject to the exclusive jurisdiction of the competent courts in that jurisdiction.
                    </p>
                    <p class="mb-6">
If you have any questions or concerns about these Terms of Use, please contact us at [{{env('CONTACT_EMAIL')}}].
                    </p>

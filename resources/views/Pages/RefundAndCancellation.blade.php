 ...
 <!-- MODALS
    ...
    <header class="py-8 py-md-12 overlay overlay-primary overlay-80" style="background-image: url(assets/img/covers/cover-19.jpg);">
        <div class="container text-center py-xl-5">
            <h1 class="display-4 fw-semi-bold mb-0 text-white">Refund And Cancellation</h1>
        ...
        <div class="row">
            <div class="col-md-12 col-xl-12">
                <div class="tab-content" id="v-pills-tabContent">
                    ...
                    <p class="mb-6">
1. Eligibility: Our refund and cancellation policy applies to all purchases made through our platform.
                    </p>
                    <p class="mb-6">
2. Cancellation by the User: Users have the option to cancel their purchase within a specified timeframe. The cancellation request should be submitted through our designated channels, such as contacting customer support or using the cancellation feature on our website.
                    </p>
                    <p class="mb-6">
3. Refund Eligibility: Refunds are subject to specific conditions. Eligibility for a refund depends on factors such as the type of product or service purchased and the timing of the cancellation request.
                    </p>
                    <p class="mb-6">
4. Timeframe for Refund Requests: Refund requests must be made within a designated timeframe from the date of purchase. After this period, refunds may not be applicable.
                    </p>
                    <p class="mb-6">
5. Non-Refundable Items or Services: Certain items or services may be non-refundable, and this will be clearly stated during the purchase process. Examples may include digital downloads, personalized products, or services that have already been rendered.
                    </p>
                    <p class="mb-6">
6. Refund Processing Time: Refunds will be processed within a reasonable timeframe. The exact processing time may vary depending on factors such as the payment method used and financial institution processing times.
                    </p>
                    <p class="mb-6">
7. Refund Method: Refunds will typically be issued using the original payment method used for the purchase. Alternative refund methods may be considered under exceptional circumstances.
                    </p>
                    <p class="mb-6">
8. Partial Refunds: In some cases, partial refunds may be granted based on specific circumstances, such as partial use or consumption of a product or service.
                    </p>
                    <p class="mb-6">
9. Instructor or Third-Party Provider Discretion: If the purchase involves an instructor or third-party provider, they may have their own refund policies that apply. In such cases, the refund terms will be communicated by the instructor or provider.
                    </p>
                    <p class="mb-6">
10. Exceptions and Special Circumstances: We reserve the right to make exceptions to our refund and cancellation policy in situations of extenuating circumstances, such as technical issues, service disruptions, or other unforeseen events.
                    </p>
                    <p class="mb-6">
Please note that this summary provides a general overview of our refund and cancellation policy. The specific terms and conditions applicable to your purchase will be provided during the checkout process or in the terms of service. We recommend reviewing the detailed policy for the specific product or service you are considering purchasing. If you have any questions or concerns, please contact our customer support for assistance.
                    </p>
